"""
Django settings for EDTech_AI project.
...
ALLOWED_HOSTS = ["*"] # for pythonanywhere live type this othewise "*"
...
WSGI_APPLICATION = 'EDTech_AI.wsgi.application'
